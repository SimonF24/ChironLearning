...
class CommentDetailsForm(CommentSecurityForm):
    ...
    votes = forms.IntegerField(label=_("Votes"), required=False)
    # Translators: 'Comment' is a noun here.
    comment = forms.CharField(label=_('Comment'), widget=forms.Textarea(attrs={'class':'form-control','placeholder':'Write your comment here', 'rows':'3',}),
