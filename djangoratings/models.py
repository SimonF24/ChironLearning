...
class Vote(models.Model):
    ...
    user            = models.ForeignKey(AUTH_USER_MODEL, blank=True, null=True, related_name="votes", on_delete=models.CASCADE)
...
class SimilarUser(models.Model):
    from_user       = models.ForeignKey(AUTH_USER_MODEL, related_name="similar_users", on_delete=models.CASCADE)
    to_user         = models.ForeignKey(AUTH_USER_MODEL, related_name="similar_users_from", on_delete=models.CASCADE)
